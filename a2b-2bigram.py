...
train_data, test_data, train_category, test_category = train_test_split(tfidf_matrix_bigram, categories, test_size = 0.3)
...
nb_conf_matrix = confusion_matrix(test_category, predicted)
